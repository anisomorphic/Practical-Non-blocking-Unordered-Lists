...
/**
 * STM-inefficient.1 - forked from 2.0 - directly CASing fields by having state be atomic
...
//    			insert(keys[i]);
    ...
    */
    ...
    public void enlistDoAtomic(Node h, Node old) throws TransactionException {
        try {
            //de-optimization: moving the initial and reinitializations into the transaction
            old = head.get();
            h.next = old;
            ...
            //de-optimization: move into main loop, instead of reinitalizing here
//            old = head.get();
//            h.next = old;
        }
    }
